 ...
 */
final class Version20191121144512 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE alert (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, activity_id INT DEFAULT NULL, max_price INT NOT NULL, postal_code VARCHAR(5) NOT NULL, INDEX IDX_17FD46C1A76ED395 (user_id), INDEX IDX_17FD46C181C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE wish_list (id INT AUTO_INCREMENT NOT NULL, bien_id INT UNSIGNED DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_5B8739BDBD95B80F (bien_id), INDEX IDX_5B8739BDA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE criteria_user (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, activity_id INT DEFAULT NULL, max_price INT NOT NULL, postal_code VARCHAR(5) NOT NULL COLLATE utf8mb4_unicode_ci, INDEX IDX_9394B4A681C06096 (activity_id), INDEX IDX_9394B4A6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE list_property_by_user (id INT AUTO_INCREMENT NOT NULL, bien_id INT UNSIGNED DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_59D998D2A76ED395 (user_id), INDEX IDX_59D998D2BD95B80F (bien_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
